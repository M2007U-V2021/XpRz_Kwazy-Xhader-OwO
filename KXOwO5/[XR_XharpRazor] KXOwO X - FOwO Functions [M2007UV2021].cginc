...
float2 FOwO_UVCoordTransform_CirprjX(float2 input, float H, float R)
{
    // 0 <= H <= 1
    // 0.5 <= R 
...
float2 FOwO_UVCoordTransform_CirprjY(float2 input, float H, float R)
{
    // 0 <= H <= 1
    // 0.5 <= R 
...
float2 FOwO_UVCoordTransform_Stochas(float2 input, float R, int iter, int InstructionOffset)
{
    ...
    */
    ...
    while(iterCount < iter)
    {
        ...
        else if(OperationType == 4){CollectResult = CollectResult / max(ReadBox,1);}
        else if(OperationType == 5){CollectResult = CollectResult % max(ReadBox,1);}
        else if(OperationType == 6){CollectResult = pow(CollectResult,2);}
        else if(OperationType == 7){CollectResult = pow(CollectResult,0.5);}
...
float2 FOwO_UVCoordTransform_TModJunction(float2 inputUV, int Tmod, vector TVec)
{
    ...
    else if(Tmod ==  1){outputUV = FOwO_UVCoordTransform_Offset(inputUV, TVec.x, TVec.y, TVec.z, TVec.w);}
    else if(Tmod ==  2){outputUV = FOwO_UVCoordTransform_Rotate(inputUV, TVec.x, TVec.y, TVec.z, TVec.w);}
    else if(Tmod ==  3){outputUV = FOwO_UVCoordTransform_Scale(inputUV, TVec.x, TVec.y);}
    else if(Tmod ==  4){outputUV = FOwO_UVCoordTransform_Pixel(inputUV, TVec.x, TVec.y);}
    else if(Tmod ==  5){outputUV = FOwO_UVCoordTransform_SkewX(inputUV, TVec.x, TVec.y);}
    else if(Tmod ==  6){outputUV = FOwO_UVCoordTransform_SkewY(inputUV, TVec.x, TVec.y);}
    else if(Tmod ==  7){outputUV = FOwO_UVCoordTransform_Radial(inputUV, TVec.x, TVec.y, TVec.z, TVec.w);}
    else if(Tmod ==  8){outputUV = FOwO_UVCoordTransform_CirprjX(inputUV, TVec.x, TVec.y);}
    else if(Tmod ==  9){outputUV = FOwO_UVCoordTransform_CirprjY(inputUV, TVec.x, TVec.y);}
    else if(Tmod == 10){outputUV = FOwO_UVCoordTransform_Stochas(inputUV, TVec.x, TVec.y, TVec.z);}
...
(
    ...
    vector TVecShft, vector TVecRott, vector TVecScPx, 
    vector TVecSkew, vector TVecRadl, vector TVecCrpj,
...
)
{
    ...
    while(TempMode != 0)
    {
        ...
        {
            CurrentUV = FOwO_UVCoordTransform_Offset(CurrentUV, TVecShft.x, TVecShft.y, TVecShft.z, TVecShft.w);
        }
        else if(CurrentInstruction == 2)
        {
            CurrentUV = FOwO_UVCoordTransform_Rotate(CurrentUV, TVecRott.x, TVecRott.y, TVecRott.z, TVecRott.w);
        }
        else if(CurrentInstruction == 3)
        {
            CurrentUV = FOwO_UVCoordTransform_Scale(CurrentUV, TVecScPx.x, TVecScPx.y);
        }
        else if(CurrentInstruction == 4)
        {
            CurrentUV = FOwO_UVCoordTransform_Pixel(CurrentUV, TVecScPx.z, TVecScPx.w);
        }
        else if(CurrentInstruction == 5)
        {
            CurrentUV = FOwO_UVCoordTransform_SkewX(CurrentUV, TVecSkew.x, TVecSkew.y);
        }
        else if(CurrentInstruction == 6)
        {
            CurrentUV = FOwO_UVCoordTransform_SkewY(CurrentUV, TVecSkew.z, TVecSkew.w);
        }
        else if(CurrentInstruction == 7)
        {
            CurrentUV = FOwO_UVCoordTransform_Radial(CurrentUV, TVecRadl.x, TVecRadl.y, TVecRadl.z, TVecRadl.w);
        }
        else if(CurrentInstruction == 8)
        {
            CurrentUV = FOwO_UVCoordTransform_CirprjX(CurrentUV, TVecCrpj.x, TVecCrpj.y);
        }
        else if(CurrentInstruction == 9)
        {
            CurrentUV = FOwO_UVCoordTransform_CirprjY(CurrentUV, TVecCrpj.z, TVecCrpj.w);
        }
        else
        {
            CurrentUV = CurrentUV;
